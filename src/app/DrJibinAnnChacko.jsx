...
export default function DrJibinAnnChacko() {
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-8 text-gray-800">
            ...
            <section className="space-y-3">
                ...
                <p className="leading-relaxed">
                    Her approach to healthcare goes beyond treating symptoms, focusing on the interconnection between body, mind, and lifestyle. By combining naturopathic therapies with evidence-based nutritional guidance and reflective counselling, Dr. Jibin supports individuals in achieving sustainable health, inner balance, and personal well-being.
                </p>
            </section>
            ...
            <section className="pt-4 border-t border-gray-100">
                <p className="leading-relaxed font-medium italic text-gray-700">
                    Known for her compassionate and thoughtful approach, she is dedicated to guiding people toward natural healing, preventive health, and meaningful lifestyle transformation.
                </p>
            </section>
        </div>
    );
