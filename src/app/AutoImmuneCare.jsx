        ...
        <div className="bg-white font-sans text-gray-900 overflow-x-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="max-w-3xl mx-auto text-lg md:text-2xl text-blue-50 mb-10 leading-relaxed font-medium">
                            ...
                            <span className="text-blue-200 italic">When Autoimmunity Becomes Exhausting… It’s Time for Regeneration — Not Just Suppression.</span>
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-blue-900 text-white p-12 md:p-16 rounded-[4rem] shadow-2xl relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-2xl md:text-3xl font-bold mb-8 italic">The Immune Regeneration Retreat is a structured, physician-led, integrative program designed to:</h3>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2">
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold text-blue-950 mb-8 tracking-tight">🧬 Our Philosophy</h2>
                            <p className="text-2xl text-gray-700 italic border-l-4 border-blue-600 pl-6 mb-8 leading-relaxed">
                                Autoimmune disease is rarely a single-trigger condition. We work on the <span className="text-blue-600 font-bold underline decoration-blue-200">terrain</span> — not just the symptoms.
                            </p>
                        </div>
                        <div className="lg:w-1/2">
                            <div className="bg-slate-50 p-10 rounded-[3.5rem] border border-slate-200">
                                <h3 className="text-xl font-bold mb-8 text-slate-800">Addressing the core imbalances:</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {phases.map((phase, idx) => (
                            ...
                            >
                                ...
                                {phase.duration && <p className="text-blue-600 font-bold mb-6 italic">{phase.duration}</p>}

                                {phase.description && <p className="text-gray-800 font-semibold mb-4 text-sm">{phase.description}</p>}
                                    ...
                                    <div className="space-y-8">
                                        {phase.subSections.map((sub, i) => (
                                            <div key={i} className="pt-6 border-t border-gray-200/50">
                                                ...
                                                {sub.description && <p className="text-sm text-gray-600 mb-3 italic">{sub.description}</p>}
                                                {sub.items && (
                                                ...
                                                {sub.goals && (
                                                    <div className="bg-white/50 p-4 rounded-2xl border border-gray-200/50">
                                                        <p className="text-xs font-bold text-blue-900 mb-2 uppercase tracking-wider">Goals:</p>
                                                        <ul className="space-y-1">
                                                            {sub.goals.map((g, k) => (
                                                                <li key={k} className="text-xs text-gray-700 flex gap-2">
                                                                    <CheckCircle2 className="w-3.5 h-3.5 text-blue-600" /> {g}
                                                                </li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                                )}
                                                {sub.note && <p className="text-xs text-gray-500 italic mt-3">{sub.note}</p>}
                                                {sub.specialNote && <p className="text-sm font-bold text-blue-900 mt-4 leading-relaxed">{sub.specialNote}</p>}
                                            </div>
                                        ))}
                                    </div>
                                )}
                                ...
                                {phase.goal && (
                                    <div className="mt-8 pt-6 border-t border-gray-200/50">
                                        <p className="text-sm font-bold text-blue-950 uppercase tracking-widest bg-blue-100/50 px-4 py-2 rounded-xl inline-block">Goal: <span className="font-medium text-gray-700">{phase.goal}</span></p>
                                    </div>
                                )}
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                        <div className="lg:w-1/2">
                            <h2 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">🧘 Nervous System Reset</h2>
                            <p className="text-xl text-slate-400 mb-10 leading-relaxed">
                                Chronic stress amplifies autoimmune flares. Balanced cortisol = Balanced immunity.
                            </p>
                            <div className="space-y-4">
                                {resetPillars.map((item, idx) => (
                                    <div key={idx} className="flex items-center gap-4 bg-white/5 p-5 rounded-3xl border border-white/10 hover:bg-white/10 transition-all">
                        ...
                        <div className="lg:w-1/2">
                            <div className="bg-gradient-to-br from-indigo-600 to-blue-700 p-12 md:p-16 rounded-[4rem] shadow-2xl relative">
                                <h3 className="text-3xl font-extrabold mb-8">Who Is This Retreat For?</h3>
                                <ul className="space-y-6">
                                    {[
                                        ...
                                        <li key={i} className="flex gap-4">
                                            ...
                                            <span className="font-semibold text-blue-50 text-lg leading-snug">{item}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-extrabold text-blue-950 mb-6">💎 Expected Outcomes May Include</h2>
                        <p className="text-gray-600 text-lg leading-relaxed italic">
                            Immune balance is possible. Regeneration begins when the terrain is restored. Results vary based on disease severity and duration.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {outcomes.map((item, idx) => (
                            <div key={idx} className="flex items-center gap-4 group bg-slate-50 p-6 rounded-[2rem] border border-slate-100 hover:border-blue-200 transition-all">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="bg-white rounded-[4rem] p-12 md:p-20 shadow-2xl">
                            <h3 className="text-3xl font-extrabold text-slate-900 mb-12 text-center">✈️ Begin Your Immune Regeneration Journey</h3>
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                                {[
                                    { step: "Step 1", title: "Submit medical summary", desc: "Share your history with our team." },
                                    { step: "Step 2", title: "Virtual evaluation", desc: "Talk with our physician team." },
                                    { step: "Step 3", title: "Personalized proposal", desc: "Receive your custom retreat plan." },
                                    { step: "Step 4", title: "Travel coordination", desc: "Scheduling & travel assistance." }
                                ].map((item, i) => (
                                    <div key={i} className="relative">
                                        <div className="text-blue-600 font-black italic text-sm mb-4 bg-blue-50 px-3 py-1 rounded-lg inline-block">{item.step}</div>
                        ...
                        <div className="mt-20 text-center">
                            <p className="text-2xl md:text-3xl font-bold text-white mb-4 italic">Immune Balance Is Possible.</p>
                            <p className="text-xl text-blue-300 font-medium">Regeneration Begins When the Terrain Is Restored</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-slate-50 border-t border-slate-200">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-4xl font-extrabold text-slate-900 mb-16 underline decoration-blue-600/20 underline-offset-8">🏥 Why Tigris Valley Wellness Centre?</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
                        {[
                            ...
                            <div key={idx} className="flex items-center gap-4 bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:border-blue-400 transition-all hover:shadow-md">
