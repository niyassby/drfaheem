...
const StrokeRecovery = () => {
    const phases = [
        {
            ...
            content: "Detailed neurological and functional mobility evaluation. Tests include inflammatory markers, lipid profile, HbA1c, Homocysteine, B12, D3, and Magnesium. Optional Carotid Doppler and MRI review.",
            bgColor: "bg-blue-50"
        },
        {
            title: "Phase 2: Anti-Inflammatory Brain Nutrition Protocol",
            icon: <Apple className="w-8 h-8 text-green-600" />,
            content: "Mediterranean-style nutrition with optimized Omega-3s, controlled carbohydrates, and protein for muscle repair. Focus on reducing neuroinflammation and stabilizing glycemia.",
            bgColor: "bg-green-50"
        },
        {
            title: "Phase 3: Neuroplasticity & Structured Rehabilitation",
            icon: <Activity className="w-8 h-8 text-red-600" />,
            content: "Consistent neural stimulation through physiotherapy, gait training, balance retraining, upper limb activation, and speech/cognitive retraining exercises.",
            bgColor: "bg-red-50"
        },
        {
            title: "Phase 4: Advanced Circulatory & Vascular Support (EECP)",
            icon: <Heart className="w-8 h-8 text-indigo-600" />,
            content: "Enhanced External Counterpulsation to improve cerebral perfusion, endothelial function, and collateral circulation. Especially for ischemic stroke recovery.",
            bgColor: "bg-indigo-50"
        },
        {
            title: "Phase 5: Advanced IV Neuro-Metabolic Therapy",
            icon: <Droplets className="w-8 h-8 text-purple-600" />,
            content: "Customized IV support with Magnesium, B-Complex, Vit C, ALA, NAC, and L-Carnitine to reduce oxidative stress and support mitochondrial repair. IV Chelation for selected cases.",
            bgColor: "bg-purple-50"
        },
        {
            title: "Phase 6: AYUSH Integrative Therapies",
            icon: <Waves className="w-8 h-8 text-teal-600" />,
            content: "Medically supervised Ayurvedic neuro-rejuvenation, Abhyanga, and Panchakarma. Focus on reducing spasticity, improving circulation, and balancing the nervous system.",
            bgColor: "bg-teal-50"
        },
        {
            title: "Phase 7: Acupuncture & Neuro-Stimulation Therapy",
            icon: <Zap className="w-8 h-8 text-yellow-600" />,
            content: "Adjunctive motor recovery support and spasticity reduction. targets autonomic regulation and neuropathic symptoms under clinical oversight.",
    ...
    const preventions = [
        { title: "Blood pressure optimization", icon: <Heart className="text-red-500" /> },
        { title: "Lipid management", icon: <Activity className="text-blue-500" /> },
        { title: "Homocysteine reduction", icon: <Zap className="text-yellow-500" /> },
        { title: "Glycemic stability", icon: <Microscope className="text-green-500" /> },
        { title: "Endothelial protection", icon: <ShieldCheck className="text-indigo-500" /> },
        { title: "Lifestyle risk correction", icon: <UserCheck className="text-purple-500" /> }
    ];
        ...
        <div className="bg-white font-sans text-gray-900 overflow-x-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                            Advanced Stroke Recovery <br /> & Neuro-Rehabilitation
                        </h1>
                        <p className="max-w-3xl mx-auto text-lg md:text-xl text-blue-50 mb-10 leading-relaxed font-medium">
                            ...
                            Stroke recovery is about restoring dignity and quality of life.
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-blue-900 p-10 md:p-12 rounded-[3.5rem] text-white relative overflow-hidden shadow-xl shadow-blue-900/20">
                            ...
                            <p className="text-blue-100 mb-8 leading-relaxed font-medium">
                                For patients with reduced cardiac function, we offer a dedicated protocol (15–20 sessions) to support:
                            </p>
                        ...
                        <div className="bg-slate-50 p-10 md:p-12 rounded-[3.5rem] border border-slate-200">
                            <h3 className="text-2xl font-bold mb-6 text-slate-900 uppercase tracking-tight">Emotional & Cognitive Recovery</h3>
                            <p className="text-slate-700 mb-8 leading-relaxed italic">
                                Post-stroke depression and anxiety are common. We provide holistic support to rebuild confidence and balance.
                            </p>
                            <div className="grid grid-cols-2 gap-4">
                                {["Sleep regulation", "Stress reduction", "Mind-body therapy", "Caregiver counseling"].map((item, i) => (
                ...
                <div className="container mx-auto px-6 text-center">
                    <div className="max-w-4xl mx-auto bg-gradient-to-br from-slate-900 to-indigo-950 p-12 md:p-20 rounded-[4.5rem] text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 relative z-10">
                            {['3-6 Week Program', 'Pre-arrival Consult', 'Intensive Rehab', 'Airport Support'].map((item, i) => (
            ...
            <section className="py-24 bg-indigo-50 border-t border-indigo-100">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="mt-20">
                        <p className="text-2xl md:text-3xl font-bold italic text-blue-950">We don’t just rehabilitate muscles. We restore vascular, metabolic, neurological, and functional health.</p>
                    </div>
                </div>
            </section>
