        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            >
              ...
              >
                Far Infrared Sauna (FIR Sauna) is a modern, non-invasive therapy that uses infrared light waves to heat the body from the inside out, stimulating detoxification and deep relaxation.
              </motion.p>
            ...
            >
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(217,119,6,0.1)] border-[6px] border-white group">
                ...
                <img
                  src="https://i.natgeofe.com/n/189058da-e52d-42f3-80fe-5f041c5c56ab/h_14958215.jpg"
                  ...
                  alt="Far Infrared Sauna Treatment"
                />
              </div>
              ...
              >
                <div className="w-12 h-12 bg-amber-50 rounded-full flex items-center justify-center text-amber-600 shrink-0 shadow-inner">
                  <Thermometer className="w-6 h-6" />
                </div>
                <div>
                  <p className="text-sm font-bold text-slate-900 leading-tight">Non-Invasive</p>
                  <p className="text-xs text-slate-500 font-medium mt-0.5">Safe & Effective</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center relative">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-sm font-bold text-amber-600 tracking-widest uppercase">Introduction</h2>
              </div>
              ...
              <p className="text-xl text-slate-700 leading-relaxed font-medium mb-8">
                Far Infrared Sauna (FIR Sauna) is a modern, non-invasive therapy that uses infrared light waves to heat the body from the inside out.
              </p>

              <div className="bg-amber-50/50 border border-amber-100 p-6 rounded-2xl">
                <p className="text-slate-600 leading-relaxed">
                  Unlike conventional saunas that heat the surrounding air, FIR saunas penetrate <strong>3–5 cm into tissues</strong>, stimulating detoxification, circulation, and deep relaxation at lower, more tolerable temperatures. At Tigris Valley, Far Infrared sauna treatment in Kochi is offered as part of a holistic wellness and detox program.
                </p>
              </div>
            </motion.div>
              ...
              <div className="bg-amber-900 p-10 md:p-12 rounded-[2.5rem] shadow-2xl border border-amber-800 relative overflow-hidden group">
                ...
                <div className="mt-8 pt-8 border-t border-amber-800/50 relative z-10">
                  <p className="text-sm text-amber-200 leading-relaxed">
                    Combined with chelation therapy, IV nutrient drips, and dietary detox plans to maximize overall results.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col gap-6 relative z-10">
                <p className="text-lg md:text-xl text-slate-200 leading-relaxed font-medium">
                  During a session, patients relax inside a specially designed infrared sauna cabin, where far infrared waves gently raise the body's core temperature. This promotes profuse sweating, enhancing the release of stored toxins such as heavy metals, pesticides, and metabolic waste products.
                </p>
                <p className="text-amber-100/90 leading-relaxed">
                  Typical sessions last 20–40 minutes, with the sauna operating at 45–60°C—much lower than steam saunas, yet producing deeper sweat. The therapy improves blood flow, boosts metabolism, and stimulates the body's natural detox pathways.
                </p>
                <div className="bg-amber-900/30 border border-amber-500/20 p-6 rounded-2xl mt-4">
                  <p className="text-slate-300 leading-relaxed">
                    At Tigris Valley, FIR sauna therapy is combined with complementary protocols such as chelation therapy, IV nutrient drips, and dietary detox plans to maximize overall results.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            ...
            <p className="text-lg text-slate-500 font-medium leading-relaxed md:max-w-sm md:text-right">
              Supporting your body's detox and healing through non-invasive infrared therapy.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 z-20">
                ...
                <h3 className="text-2xl font-extrabold text-white mb-2">Deep Tissue Healing</h3>
                <p className="text-amber-200 text-sm font-medium">Infrared Penetrates 3–5 cm Into Tissue</p>
              </div>
            </motion.div>
