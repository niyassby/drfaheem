                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="max-w-3xl mx-auto text-lg md:text-xl text-indigo-50 mb-10 leading-relaxed font-medium">
                            At Tigris Valley Wellness Centre – Kerala, India
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-20 bg-indigo-900 text-white overflow-hidden relative">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-2xl md:text-3xl font-bold mb-12">When facing cancer, patients and families ask three questions:</h2>
                        ...
                        <p className="mt-16 text-xl text-indigo-100 leading-relaxed max-w-4xl mx-auto">
                            At Tigris Valley Wellness Centre, we offer a physician-led integrative oncology program combining Functional Medicine, metabolic support, symptom-focused palliative care, and advanced cellular immunotherapy options — designed specifically for international patients.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                            ...
                            <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                {focusAreas.map((focus, idx) => (
                                    <div key={idx} className="flex items-start gap-4 p-4 bg-indigo-50 rounded-2xl border border-indigo-100/50">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-indigo-900 group-hover:text-indigo-600 transition-colors">✔ {focus.area}</h4>
                                            <p className="text-xs text-gray-600 font-medium">{focus.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white text-center">
                            <h2 className="text-3xl font-bold mb-12">🌿 Who This Program Is For</h2>
                            <div className="flex flex-wrap justify-center gap-4">
                                {targetPatients.map((item, i) => (
                                    <span key={i} className="px-6 py-3 bg-white/10 rounded-full text-sm md:text-base font-bold text-indigo-100 border border-white/10">
                                        {item}
                                    </span>
                                ))}
                            </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col lg:flex-row gap-16 items-center">
                            <div className="lg:w-1/2">
                                <span className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-4 block">Assessment Phase</span>
                                <h2 className="text-3xl md:text-5xl font-bold mb-8 text-indigo-950 leading-tight">
                                    🔬 Step 1: Comprehensive Oncology & Metabolic Assessment
                                </h2>
                                <p className="text-lg text-gray-700 leading-relaxed mb-8">
                                    Before beginning, we conduct a structured review to ensure safety, eligibility, and personalization.
                                </p>
                            ...
                            <div className="lg:w-1/2">
                                <div className="bg-white p-10 rounded-[3.5rem] shadow-xl shadow-indigo-900/5 border border-indigo-100">
                                    <h3 className="text-2xl font-bold mb-6 text-indigo-900">Safety & Personalization</h3>
                                    <p className="text-gray-600 leading-relaxed italic font-medium">
                                        Each patient's molecular profile and current treatment protocol are carefully analyzed to create a supportive care plan that works in synergy with their primary oncology treatment.
                                    </p>
                                    <div className="mt-8 pt-8 border-t border-gray-100 flex items-center gap-4">
                                        <ShieldCheck className="w-10 h-10 text-indigo-600" />
                                        <p className="text-sm font-bold text-indigo-950 uppercase tracking-tight">Structured Medical Review Protocol</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 text-center">
                    <div className="max-w-4xl mx-auto">
                        <span className="text-emerald-600 font-bold uppercase tracking-widest text-sm mb-4 block">Nutrition Phase</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                            {metabolicPlan.map((plan, idx) => (
                                <div key={idx} className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100 text-left flex items-start gap-4">
                                    <span className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shrink-0 shadow-sm text-emerald-600">
                                        {idx + 1}
                                    </span>
                                    <span className="text-gray-800 font-bold text-sm leading-tight">{plan}</span>
                                </div>
                            ))}
                        </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-white p-10 md:p-12 rounded-[3.5rem] shadow-xl border border-indigo-50">
                            <h2 className="text-3xl font-bold mb-8 text-indigo-950">💉 Step 3: Advanced IV Integrative Therapies</h2>
                            <p className="text-gray-600 mb-8 italic font-medium uppercase tracking-tight">All therapies are physician-supervised and individualized.</p>
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm text-gray-700 font-bold">
                                        {["Fatigue reduction", "Neuropathy care", "Energy restoration", "Detoxification"].map((item, i) => (
                                ...
                                <div className="p-4 bg-rose-50 rounded-2xl border border-rose-100 flex items-center gap-4 text-rose-700 font-bold">
                                    ...
                                    <span>Safety screening is mandatory for all IV therapies.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-10 md:p-12 rounded-[3.5rem] shadow-xl border border-orange-50">
                            <h2 className="text-3xl font-bold mb-8 text-orange-950">🔥 Step 4: Far Infrared (FIR) Therapy</h2>
                            <p className="text-orange-900/60 mb-8 font-medium italic">FIR therapy provides gentle thermal support that may:</p>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-fit">
                                {[
                                    { text: "Improve circulation", icon: <Activity className="text-orange-500" /> },
                                    { text: "Promote relaxation", icon: <Heart className="text-orange-500" /> },
                                    { text: "Support lymphatic flow", icon: <Wind className="text-orange-500" /> },
                                    { text: "Improve sleep", icon: <Clock className="text-orange-500" /> },
                                    { text: "Enhance detoxification", icon: <Droplets className="text-orange-500" /> }
                                ].map((item, i) => (
                                    <div key={i} className="flex items-center gap-4 p-5 bg-orange-50 rounded-2xl border border-orange-100">
                                        {item.icon}
                                        <span className="font-bold text-orange-900 text-sm leading-tight">{item.text}</span>
                                    </div>
                                ))}
                            </div>
            ...
            <section className="py-24 bg-indigo-950 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        <span className="inline-block px-4 py-1 bg-indigo-500 rounded-full text-xs font-bold uppercase tracking-widest mb-6">Advanced Research & Clinical Support</span>
                        ...
                        <p className="text-indigo-200 text-xl max-w-3xl mx-auto">
                            For eligible patients, we coordinate advanced immune-based therapies through specialized collaborations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="bg-white/5 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 flex flex-col justify-between">
                            <div>
                                <h3 className="text-3xl font-bold mb-6 flex items-center gap-4">
                                    <Microscope className="w-10 h-10 text-indigo-400" /> 🧪 Dendritic Cell Therapy
                                </h3>
                                <p className="text-indigo-100 text-lg mb-8 leading-relaxed italic first-line:uppercase font-bold tracking-tight">
                                    Dendritic cells help the immune system recognize tumor antigens.
                                </p>

                                <div className="space-y-6 mb-12">
                                    <p className="font-bold text-sm text-indigo-300 uppercase tracking-widest">Process Overview:</p>
                                    {[
                            ...
                            <div className="mt-auto pt-8 border-t border-white/10">
                                <p className="text-indigo-300 font-bold text-sm mb-4">Eligibility depends on:</p>
                                <div className="flex flex-wrap gap-2">
                                    {["Tumor type", "Disease burden", "Overall health status"].map((tag, i) => (
                                        <span key={i} className="px-3 py-1 bg-indigo-500/40 rounded-full text-[10px] font-bold uppercase tracking-widest">{tag}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 flex flex-col justify-between">
                            <div>
                                <h3 className="text-3xl font-bold mb-6 flex items-center gap-4">
                                    <Activity className="w-10 h-10 text-emerald-400" /> 🛡 Natural Killer (NK) Cell Therapy
                                </h3>
                                <p className="text-emerald-100 text-lg mb-8 leading-relaxed italic first-line:uppercase font-bold tracking-tight">
                                    NK cells are part of innate immunity and target abnormal cells.
                                </p>

                                <div className="space-y-6 mb-12">
                                    <p className="font-bold text-sm text-emerald-300 uppercase tracking-widest">In this therapy:</p>
                                    {[
                                    ...
                                    <div className="mt-8">
                                        <p className="font-bold text-sm text-emerald-300 uppercase tracking-widest mb-4">Potential Objectives:</p>
                                        <div className="space-y-2">
                                            {["Enhance immune surveillance", "Support tumor-targeted immune response"].map((obj, idx) => (
                                                <div key={idx} className="flex items-center gap-3">
                                                    <Sparkles className="w-4 h-4 text-emerald-400" />
                                                    <span className="text-indigo-50 font-bold">{obj}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="mt-auto pt-8 border-t border-white/10">
                                <div className="p-4 bg-emerald-500/20 rounded-2xl flex items-center gap-4 text-emerald-100 font-bold italic text-sm">
                                    ...
                                    <span>Strict eligibility and medical screening are required.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                                {[
                                    { text: "Pain relief support", icon: <Activity className="text-indigo-600" /> },
                                    { text: "Fatigue management", icon: <Zap className="text-indigo-600" /> },
                                    { text: "Appetite improvement", icon: <Apple className="text-indigo-600" /> },
                                    { text: "Neuropathy care", icon: <Activity className="text-indigo-600" /> },
                                    { text: "Emotional and spiritual support", icon: <Heart className="text-indigo-600" /> },
                                    { text: "Comfort-focused IV nutritional drips", icon: <Droplets className="text-indigo-600" /> }
                                ].map((item, idx) => (
                                    <div key={idx} className="flex items-center gap-4 p-5 bg-indigo-50 rounded-2xl border border-indigo-100/50">
                                        <div className="p-2 bg-white rounded-xl shadow-sm">
                                            {item.icon}
                                        </div>
                                        <span className="font-bold text-indigo-900 text-sm leading-tight">{item.text}</span>
                                    </div>
                                ))}
                            </div>
                            <div className="bg-indigo-900 text-white p-6 rounded-2xl text-center">
                                <p className="text-lg font-bold italic tracking-wider">We prioritize dignity, clarity, and comfort.</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/2 bg-gray-50 p-10 md:p-12 rounded-[3.5rem] shadow-xl border border-gray-100">
                            ...
                            <p className="text-gray-600 mb-10 italic font-bold">
                                Cancer-related muscle loss worsens outcomes. Our structured support includes:
                            </p>
                            <div className="space-y-6">
                                {[
                                    { title: "Light supervised resistance exercises", desc: "Targeted to patient energy levels." },
                                    { title: "Fatigue-adapted movement", desc: "Gentle physical support." },
                                    { title: "Nutritional muscle preservation", desc: "Optimizing protein and caloric intake." },
                                    { title: "Post-treatment rehabilitation support", desc: "Transitioning back to functional life." }
                                ].map((step, idx) => (
                                    <div key={idx} className="flex gap-6 group">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 group-hover:text-indigo-600 transition-colors uppercase tracking-tight">{step.title}</h4>
                                            <p className="text-sm text-gray-500 font-medium italic">{step.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto bg-white/5 backdrop-blur-xl p-10 md:p-20 rounded-[4rem] border border-white/10">
                        ...
                        <div className="bg-white/10 p-10 rounded-[2.5rem] border border-white/20">
                            <h3 className="text-2xl text-white font-bold mb-8 text-center uppercase tracking-widest flex items-center justify-center gap-4">
                                <ShieldCheck className="w-8 h-8" /> ⚖ Ethical & Medical Integrity
                            </h3>
                            <div className="flex flex-wrap justify-center gap-6 mb-8 text-indigo-100">
                                {["Does not replace standard oncology treatment", "Is not presented as a cure", "Requires oncologist coordination", "Is individualized", "Follows careful screening protocols"].map((point, i) => (
            ...
            <section className="py-24 bg-white border-t border-gray-100">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl md:text-5xl font-bold text-indigo-950 mb-8 italic">🌿 Why Choose Tigris Valley Wellness Centre?</h2>
                        <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto">
                            {[
                                ...
                                <div key={idx} className="flex items-center gap-4 bg-gray-50 p-6 rounded-2xl border border-indigo-50 shadow-sm">
                                    <CheckCircle2 className="text-emerald-500 shrink-0" />
                                    <span className="font-bold text-gray-800 text-left leading-tight uppercase tracking-tight">{item}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="max-w-4xl mx-auto bg-gradient-to-br from-indigo-700 to-indigo-900 rounded-[3rem] p-12 md:p-20 text-white text-center shadow-2xl">
                        <h2 className="text-3xl md:text-5xl font-bold mb-10 leading-tight">📞 Begin Your Consultation</h2>
                        <p className="text-indigo-100 text-lg mb-12">If you or your loved one is seeking:</p>
                        <div className="flex flex-wrap justify-center gap-4 mb-16">
                            {[
                                ...
                                <span key={i} className="px-6 py-3 bg-white/10 rounded-full text-sm font-bold text-white border border-white/20 italic">
                                    ✓ {item}
                                </span>
                            ))}
                        </div>
                        <p className="text-xl font-bold italic mb-12 text-indigo-200 uppercase tracking-widest first-line:lowercase leading-tight">
                            Our team will guide you through a structured eligibility and consultation process.
                        </p>
                        <button className="bg-white text-indigo-900 px-12 py-6 rounded-full font-bold text-xl hover:bg-indigo-50 transition transform hover:scale-105 uppercase tracking-widest shadow-xl">
                            Request Case Review
                        </button>
                    </div>
                </div>
