          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="mt-16 text-xl text-indigo-100 leading-relaxed max-w-4xl mx-auto">
                At Tigris Valley Wellness Centre, we offer a physician-led
            ...
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-indigo-700 to-indigo-900 rounded-[3rem] p-12 md:p-20 text-white text-center shadow-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-16">
                {[
                  ...
                  <span
                    key={i}
                    className="px-6 py-3 bg-white/10 rounded-full text-sm font-bold text-white border border-white/20 italic"
                  >
                    ✓ {item}
                  </span>
                ))}
              ...
              <p className="text-xl font-bold italic mb-12 text-indigo-200 uppercase tracking-widest first-line:lowercase leading-tight">
                Our team will guide you through a structured eligibility and
