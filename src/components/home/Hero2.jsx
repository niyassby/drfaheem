...
import img from "../../assets/Faheemdrimg.jpeg";
...
const Hero2 = () => {
  ...
  return (
    <div ref={heroRef} className="w-full min-h-screen overflow-hidden md:h-screen bg-[#fefcf6] border-b">
        ...
        <section className="w-full relative z-10 grid grid-cols-1 max-md:-mb-25 max-md:grid-rows-[3fr_2fr] md:grid-cols-2 h-full">
          <div className="w-full h-full row-span-1 col-span-1 flex flex-col items-start md:justify-center order-2 md:order-1 md:pl-6 xl:pl-28 2xl:pl-40 p-6 pt-8 md:pt-6">
            ...
            <div className={`flex max-md:flex-col gap-2 mt-5 transition-all duration-500 ${isFinish ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              ...
              <a href="https://wa.me/919072661149" target="_blank" rel="noopener noreferrer">
                <button className="bg-gradient-to-tr from-20% cursor-pointer border shadow-none hover:shadow-[0px_0px_40px_13px_rgba(42,149,173,0.3)] border-primary-500 hover:border-secondary-500 from-primary-500 to-secondary-500 text-white px-6 py-3 text-sm font-medium rounded-full transition-all duration-300 flex items-center gap-2">
